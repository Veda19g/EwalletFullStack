...
try{
    ...
    const response=await axios.post("https://ewalletfullstack-1.onrender.com/api/v1/user/signup",user,{
...
export const login=async(user)=>{
    try {
        console.log("user",user);
    const response = await axios.post("https://ewalletfullstack-1.onrender.com/api/v1/user/signin", 
    user ,
    {
        withCredentials: true,
        headers: {
