...
const Home = () => {
  ...
  return (
    <div>
      <Navbar/>
      <div className='bg-slate-600 h-screen flex-col'>
        <div className='flex flex-col'>
         ...
         <div className='flex md:flex-row justify-center mt-14 gap-5 text-2xl flex-col p-4 md:p-0'>
            <div className='p-4 bg-slate-200 rounded-lg'>Request For Money</div>
            <div className='p-4 bg-slate-200 rounded-lg'>Track your Expense</div>
            <div className='p-4 bg-slate-200 rounded-lg'>Send Money</div>
         </div>
         ...
         <div className='flex justify-center mt-12 md:gap-10 gap-5'>
            ...
            <button className='md:py-3 md:px-8 py-3 px-4 rounded-lg bg-green-500 text-slate-50 font-mono font-semibold text-3xl' onClick={handleTry}>Try out yourself</button>
         </div>
         </div>
      </div>
    </div>
